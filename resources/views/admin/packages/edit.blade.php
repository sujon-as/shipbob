                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                       placeholder="Title" required="" value="{{old('title',$package->title)}}">
                                @error('title')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="recharge_amount" class="form-control numericInput" id="recharge_amount"
                                       placeholder="Recharge Amount" required="" value="{{old('recharge_amount',$package->recharge_amount)}}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control description" required="" name="description">{!!old('description',$package->description)!!}</textarea>
                                @error('description')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="bonus_amount" class="form-control numericInput" id="bonus_amount"
                                       placeholder="Bonus Amount" required="" value="{{old('bonus_amount',$package->bonus_amount)}}">
                                @error('bonus_amount')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
