    ...
    <section class="content">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Edit Credit</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                    placeholder="Credit Name" required="" value="{{old('title',$credit->title)}}">
                                @error('title')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    class="dropify"
                                    data-height="150"
                                    data-default-file="{{ URL::to($credit ? $credit->img : '') }}"
                                />
                                @error('file')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
