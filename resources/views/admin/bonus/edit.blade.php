                ...
                <form action="{{route('gifts.update', $gift->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="frozen_amounts">Reserved Amount (BDT) <span class="required">*</span></label>
                                    <input type="text" name="frozen_amounts" class="form-control numericInput" id="frozen_amounts"
                                           placeholder="Reserved Amount (BDT)" required=""
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="frozen_amount_task_will_block">No. of task will be blocked for frozen amount <span class="required">*</span></label>
                                    <input type="number" name="frozen_amount_task_will_block" class="form-control numericInput" id="frozen_amount_task_will_block"
                                           placeholder="No. of task will be blocked for frozen amount" required=""
